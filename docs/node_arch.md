...
<details>
<summary><strong>Full Node-RED flow [EXPAND]</strong></summary>
<img src="images/FlowNodeREd.png" alt="Full Node-RED flow" style="max-width:100%;height:auto;" />
<p><em>Debug nodes are used for backend debugging.</em></p>
</details>
...
<details>
<summary><strong>Initializing Values Flow [EXPAND]</strong></summary>
<img src="images/InitializingValuesNodeRed.png" alt="Initializing Values Flow" style="max-width:100%;height:auto;" />
</details>
...
The values are published onto the dashboard using a text node (_Current Temp ESP-#_), while temperature values are checked using function nodes (_Get Message for Temperature_).
<details>
<summary><strong>Publishing/Manipulating Flow [EXPAND]</strong></summary>
<img src="images/Pub_Man_Flow.png" alt="Publishing/Manipulating Flow" style="max-width:100%;height:auto;" />
</details>
...
## **Plotting / Finalizing**
Below is the image displaing the plotting and finalizing of the flow.
<details>
<summary><strong>Plot/Finalizing Flow [EXPAND]</strong></summary>
<img src="images/Plot_Fin_Flow.png" alt="Plot/Finalizing Flow" style="max-width:100%;height:auto;" />
</details>
...
<details>
<summary><strong>LED Function Code [EXPAND]</strong></summary>
<img src="images/ledCode.png" alt="LED Function Code" style="max-width:100%;height:auto;" />
</details>
...
The Final part is the setting that changes the threshold values for each node individually. This is done in the flow below.
<details>
<summary><strong>Threshold Flow [EXPAND]</strong></summary>
<img src="images/Threshold_setting.png" alt="Threshold Flow" style="max-width:100%;height:auto;" />
</details>
...
<details>
<summary><strong>Node-RED Dashboard [EXPAND]</strong></summary>
<img src="images/dashboard.png" alt="Node-RED Dashboard" style="max-width:100%;height:auto;" />
</details>
